...
#define APIKEY         "PYHULQezDSA7XNreDjhDz7uavPmSAKxSZTdGYkRGNVVHcz0g" // your cosm api key
#define FEEDID         66331 // your feed ID
#define USERAGENT      "Shibuya Apartment Sensors (66331)" // user agent is the project name

// assign a MAC address for the ethernet controller.
// Newer Ethernet shields have a MAC address printed on a sticker on the shield
// fill in your address here:
byte mac[] = { 0x90, 0xA2, 0xDA, 0x00, 0x75, 0xED};
